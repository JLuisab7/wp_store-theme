$(function() {
  ...
  if ($('html').hasClass('ie')) {
    ...
    new Share(".share-button", {
      ...
      $('#cart').mmenu({
        offCanvas: { position: 'bottom', zposition : "front", pageSelector: "#content_wrapper" },
        classes: "mm-black"
      });
      ...
      $.ajax({
        ...
        success: function(itemData) {
          ...
          window.setTimeout(function(){
            ...
            $addToCartBtn.find('span').addClass("fadeOut").text("Add to Cart").removeClass('fadeIn').removeClass("fadeOut").addClass('zoomIn');
          }, 2000);
  ...
  selectCallback = function(variant, selector) {
    ...
    if (variant && variant.available == true) {
      ...
      $('.add_to_cart', $product).removeClass('disabled').removeAttr('disabled').find('span').text('Add to Cart');
      $notify_form.hide();
    } else {
